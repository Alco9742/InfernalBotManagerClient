...
INSTRUCTIONS:
Before you're able to use the program you need an account at [TODO].
...
accounts=5 --> Amount of account to grab from the server (should be 5x the amount of groups on that client). These get taken from the active accounts with highest priority (closest to 0) with the highest level.
